    ...
    return ( 
        ...
        <div className="h-10 2k:h-16 4k:h-22 w-full bg-gradient-to-b from-neutral-400 to-transparent backdrop-blur-xs
         ...
         />
            ...
            <div className="w-full h-[1200px] md:h-[900px] lg:h-[550px] 4k:h-[700px] flex flex-col">
                <div className="max-lg:mt-6 h-2/4 w-full flex flex-col lg:flex-row">
                    <div className="h-2/4 lg:h-full w-full lg:w-1/5 4k:w-2/5 lg:border-r-2 flex items-center justify-center order-2 lg:order-1">
                        ...
                        width={100}
                        height={100}
                        className="object-contain size-4/6 lg:size-5/6 2k:size-4/6 4k:size-5/6 max-md:-mt-20 pointer-events-none"
                        />
                    </div>
                    <div className="h-2/4 lg:h-full w-full lg:w-4/5 4k:w-3/5 lg:ml-10 flex max-lg:items-center flex-col order-1 lg:order-2 lg:p-6">
                        <h3 className="text-xl 4k:text-3xl p-4 h-10 w-full flex items-center justify-center lg:justify-start">
                            Non - Expert users
                        </h3>
                        <p className="text-base lg:text-lg 4k:text-2xl text-center lg:text-start mt-4 p-4 max-w-xl md:max-w-2xl xl:max-w-6xl">
                ...
                <div className="h-2/4 w-full flex flex-col lg:flex-row lg:border-t-2">
                    <div className="h-2/4 lg:h-full w-full lg:w-1/5 4k:w-2/5 lg:border-r-2 flex items-center justify-center order-2 lg:order-1">
                            ...
                            width={100}
                            height={100}
                            className="object-contain size-4/6 lg:size-5/6 2k:size-4/6 4k:size-5/6 pointer-events-none"
                            />
                        </div>
                        <div className="h-2/4 lg:h-full w-full lg:w-4/5 4k:w-3/5 lg:ml-10 flex max-lg:items-center flex-col order-1 lg:order-2 lg:p-6">
                            <h3 className="text-xl 4k:text-3xl p-4 h-10 w-full flex items-center justify-center lg:justify-start">
