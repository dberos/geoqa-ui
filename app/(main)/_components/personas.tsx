...
const Personas = () => {
    return ( 
        ...
        <div className="h-10 w-full bg-gradient-to-b from-neutral-400 to-transparent backdrop-blur-xs
         ...
         />
        <div className="w-full h-[1200px] md:h-[700px] lg:h-[500px] 4k:h-[700px]">
            <div className="h-20 lg:h-32 w-full flex items-center justify-center lg:justify-start">
                <h2 className="lg:ml-20 text-2xl 4k:text-3xl border-2 border-neutral-600 border-dashed p-3 rounded-sm bg-neutral-200 dark:bg-neutral-900">
            ...
            <div className="w-full h-full flex flex-col">
                <div className="max-lg:mt-6 h-2/4 w-full flex flex-col lg:flex-row">
                    <div className="h-2/4 lg:h-full w-full lg:w-1/5 4k:w-2/5 lg:border-r-2 flex items-center justify-center order-2 lg:order-1">
                        ...
                        width={100}
                        height={100}
                        className="object-contain size-3/6 md:size-4/6 lg:size-5/6 max-md:-mt-20"
                        />
                    </div>
                    <div className="h-2/4 lg:h-full w-full lg:w-4/5 4k:w-3/5 lg:ml-10 flex flex-col order-1 lg:order-2 lg:p-6">
                        <h3 className="text-xl 4k:text-2xl p-4 h-10 w-full flex items-center justify-center lg:justify-start">
                            Non - Expert users
                        </h3>
                        <p className="text-base lg:text-lg 4k:text-xl text-center lg:text-start mt-4 p-4 max-w-7xl 4k:max-w-9xl">
                ...
                <div className="h-2/4 w-full flex flex-col lg:flex-row lg:border-t-2">
                    <div className="h-2/4 lg:h-full w-full lg:w-1/5 4k:w-2/5 lg:border-r-2 flex items-center justify-center order-2 lg:order-1">
                            ...
                            width={100}
                            height={100}
                            className="object-contain size-3/6 md:size-4/6 lg:size-5/6"
                            />
                        </div>
                        <div className="h-2/4 lg:h-full w-full lg:w-4/5 4k:w-3/5 lg:ml-10 flex flex-col order-1 lg:order-2 lg:p-6">
                            <h3 className="text-xl 4k:text-2xl p-4 h-10 w-full flex items-center justify-center lg:justify-start">
