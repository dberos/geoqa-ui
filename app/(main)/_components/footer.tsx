...
const Footer = () => {
    return ( 
        <footer className="mt-14 h-[650px] w-full md:h-80 lg:h-56 2k:h-72 4k:h-96 2k:p-8 4k:p-16 
        ...
        >
            ...
            >
                ...
                <h3 className="text-base text-center mt-2 md:mt-0 md:text-center lg:text-start">
                    Department of Informatics & Telecommunications
                    <br />
                    National and Kapodistrian University of Athens, Greece
                </h3>
            </div>
            <div className="order-1 grid grid-rows-3 grid-cols-1 md:grid-rows-1 md:grid-cols-3 lg:order-2">
