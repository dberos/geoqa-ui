...
const Services = () => {
    return ( 
        <div className="mt-10 lg:mt-20 w-full h-[800px] md:h-[700px] lg:h-[400px] 4k:h-[600px] 4k:pl-96 4k:pr-96 grid grid-cols-1 grid-rows-2 lg:grid-cols-2 lg:grid-rows-1">
