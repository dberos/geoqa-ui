...
function SearchCommand({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "bg-popover text-popover-foreground flex h-auto w-full flex-col overflow-hidden rounded-md",
        className
      )}
      {...props}
    />
...
function SearchCommandList({
  ...
  return (
    <CommandPrimitive.List
      data-slot="command-list"
      className={cn(
        "bg-neutral-100 dark:bg-neutral-900 max-h-[300px] scroll-py-1 overflow-x-hidden overflow-y-auto",
        className
      )}
      {...props}
    />
...
function SearchCommandGroup({
  ...
  return (
    <CommandPrimitive.Group
      data-slot="command-group"
      className={cn(
        "border-t text-foreground [&_[cmdk-group-heading]]:text-muted-foreground overflow-hidden p-1 [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-medium",
        className
      )}
      {...props}
    />
